    ...
    div id:e.event_id, key:e.event_id, class:mclz.join(' '), title:title, ->
        if e.chat_message
            ...
            if e.otr_modification.new_otr_status is "OFF_THE_RECORD"
                pass i18n.__ 'conversation.history_off:History has been turned off for this conversation.'
            else if e.otr_modification.new_otr_status is "ON_THE_RECORD"
                pass i18n.__ 'conversation.history_on:History has been turned on for this conversation.'
            else
